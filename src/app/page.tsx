...
const demoClips = [
  ...
  {
    title: "Semi charger scout",
    detail: "Freight corridor gap",
    label: "EV charging",
    href: "https://www.linkedin.com/feed/update/urn:li:activity:7450181150549065728/",
    metric: "$800K credit",
    video: "/demos/semi-chargers/demo.mp4",
    poster: "/demos/semi-chargers/poster.jpg",
    aspect: "wide",
  },
  {
    title: "Euro Trax garage agent",
    detail: "Showroom render",
    label: "Garage",
    href: "https://www.linkedin.com/feed/update/urn:li:activity:7450518659975766016/",
    metric: "$6/sqft",
    video: "/demos/euro-trax/demo.mp4",
    poster: "/demos/euro-trax/poster.jpg",
    aspect: "wide",
  },
  {
